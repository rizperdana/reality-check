...
export const i18n = {
    id: {
        ui: {
            ...
            description:
            'Bandingin gaji sekarang vs tawaran baru. Kita bantu cek: pindah kerja beneran bikin untung, atau cuma angka cantik doang?',
            dataLabel: 'Data',
            updated: 'update',
            attentionTitle: 'FYI:',
            attentionText:
            'Ini simulasi pakai aturan umum aja ya. Angka bisa beda dari slip gaji asli. Pakai buat bandingin pilihan, bukan pengganti konsultan pajak.',
            whoFor:
            'Buat yang lagi banding-bandingin tawaran kerja baru, apalagi kalau ada perubahan pajak, commute, jam kerja, atau waktu bareng keluarga.',
            startButton: 'Mulai Cek',
            reset: 'Reset',
            loading: 'Lagi itung…',
            whyToggle: 'Kok hasilnya bisa beda?',
            whyList: [
                'Pakai asumsi umum buat PPh21 & BPJS, bukan perhitungan slip final.',
                'Potongan lain (cicilan, tunjangan khusus) gak dihitung kecuali diinput manual.',
                'Buat angka pasti, mending cek slip gaji atau tanya ahli pajak.',
            ],
            resultFor: {
                positive: 'Worth it',
                tradeoff: 'Trade-off',
            ...
            lifestylePenalty: 'Hidup jadi ribet',
            shortSummaryTitle: 'Kesimpulan',
            suggestionsTitle: 'Yang bisa dilakuin',
            aiRecommendationTitle: '🤖 Rekomendasi AI',
            notConsideredTitle: 'Yang belum dihitung',
            ...
            errors: {
                ...
                serverError: 'Error pas ngitung. Coba lagi ya.',
        ...
        suggestions: {
            negotiatePay: 'Coba nego gaji atau tunjangan transport/remote.',
            askHybrid: 'Tanya soal hybrid/WFH atau kompensasi waktu.',
            clarifyWork: 'Minta jelasnya soal jam kerja, on-call, sama cuti.',
            considerLongTerm: 'Pikirin juga benefit jangka panjang (karir, bonus).',
        },
    },
    en: {
        ui: {
